                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch">
                  <div className="hidden sm:block sm:ml-6">
                    <div className="flex space-x-4 font-Yeon ">
                      <Link
                        className="text-gray-300 cursor-pointer  hover:bg-gray-700 hover:text-green-300 px-3 py-2 rounded-md sm:text-sm  text-base  block sm:flex"
                        activeClass="bg-gray-800 text-green-500 font-bold sm:font-black px-3 py-2 rounded-md sm:text-sm text-base hover:none block sm:flex"
                        to="Home"
                        spy={true}
                        smooth={true}
                        offset={0}
